...
export default function IssueBooks() {
  ...
  const handleSubmit = (e) => {
    ...
    toast.success('Book issued successfully! QR code generated.')
  }
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-3xl font-bold text-gray-900 mb-6">Issue Books</h1>
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setBookDetails({...bookDetails, userId: e.target.value})}
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="date"
                  id="issueDate"
                  value={bookDetails.issueDate}
                  onChange={(e) => setBookDetails({...bookDetails, issueDate: e.target.value})}
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setBookDetails({...bookDetails, returnDate: e.target.value})}
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                  required
                />
              </div>
              ...
              {qrData ? (
                ...
                >
                  ...
                  <p className="mt-4 text-sm text-gray-600">
                    Scan this QR code when entering/exiting the library
                  </p>
                </motion.div>
              ) : (
